...
namespace Collect
{
    ...
    public class NeuralNetwork
    {
        ...
        public NeuralNetwork(float learningRate = 0.1f, string problemType = "classification")
        {
    ...
    public partial class Form1 : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBox1.Size = new Size(200, 250);
            ...
            this.Set_Net.Location = new Point(10, 140);
            ...
            this.Train_Button.Location = new Point(10, 175);
            ...
            this.groupBox2.Location = new Point(520, 510);
            ...
            // DÜZELTME: TextBox'ı daha geniş yap ve kültür uyumlu hale getir
            ...
            this.regressionValueTextBox.Text = "0,5"; // Türkçe format
            this.regressionValueTextBox.Visible = false;
            // DÜZELTME: KeyPress event ekle
            ...
            this.Text = "Multi-Layer Neural Network - Classification & Regression";
        ...
        // YENİ: Regression TextBox için key press event - sadece sayı ve virgül/nokta
        private void regressionValueTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            // Sadece kontrol karakterleri, rakamlar, virgül ve noktaya izin ver
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar) && e.KeyChar != ',' && e.KeyChar != '.')
            {
                e.Handled = true;
            }

            // Virgül veya noktadan sadece birine izin ver
        ...
        // DÜZELTİLMİŞ: Regression değerini kültür uyumlu okuma
        private float ParseRegressionValue(string value)
        {
            try
            {
                // Önce Türkçe formatı dene (virgül)
                if (value.Contains(','))
                {
                    return float.Parse(value, CultureInfo.GetCultureInfo("tr-TR"));
                }
                // Sonra İngilizce formatı dene (nokta)
                else
                {
        ...
        private void DrawRegressionSurface(NeuralNetwork network, float[] mean, float[] std)
        {
            ...
            using (Graphics g = Graphics.FromImage(surfaceBitmap))
            {
                ...
                for (int i = 0; i < numSample; i++)
                {
                    ...
                    // DÜZELTME: Değeri ekranda göster
        ...
        private void draw_regression_point(int temp_x, int temp_y, float value)
        {
            using (Graphics g = pictureBox1.CreateGraphics())
            {
                ...
                // DÜZELTME: Türkçe formatla göster
                Font font = new Font("Arial", 8);
                string valueText = value.ToString("F2", CultureInfo.GetCultureInfo("tr-TR"));
                g.DrawString(valueText, font, Brushes.Black, temp_x + 8, temp_y - 8);
                font.Dispose();
        ...
        // DÜZELTİLMİŞ: Regression değerini doğru okuyan mouse click
        private void pictureBox1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                // DÜZELTME: Kültür uyumlu değer okuma
        ...
        private void Set_Net_Click(object sender, EventArgs e)
        {
            ...
            network = new NeuralNetwork(learningRate, problemType);
            ...
            label4.Text = $"Status: Network Ready ({hiddenLayers + 1} layers, {problemType})";
            textBox1.AppendText($"Network initialized with {hiddenLayers + 1} layers for {problemType}\n");
        }
